...
const midiDevice = new MIDIDevice('Your midi device name');
...
const createWindow = (): void => {
  ...
  midiDevice.midiInput.on("message", (deltaTime: number, message: MidiMessage) => {
    ...
    mainWindow.webContents.send('midi-update', midiMessage);
    // mainWindow.webContents.send('update-midi', getMidiData(message, deltaTime));
  });
